...
st.set_page_config(layout="wide", page_title="수급 퀀트 비서 V6.2", page_icon="⚡")
st.title("⚡ 실전 수급 스윙 대시보드 V6.2")
st.caption("🌐 완전 자동화 (Zero-Latency) 매크로 AI 리포트 탑재")
...
if df_summary.empty:
    ...
    # 🔥 [수정] 버튼 없이 봇이 만들어둔 리포트(.md 파일)를 0.1초 만에 그대로 읽어옵니다.
    with tab3:
        ...
        if os.path.exists("report.md"):
            ...
            st.info("⏳ 오늘의 AI 마감 리포트가 아직 생성되지 않았습니다. 봇이 실행될 때 생성됩니다.")
